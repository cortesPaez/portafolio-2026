...
const Experience = ({ dictionary }: ExperienceProps) => {
	return (
		<FigmaGrid className="py-[64px] flex-1 w-full justify-between min-h-dvh">
			<section className="relative w-full flex flex-col bg-black text-white col-span-4 md:col-span-8 lg:col-span-12 gap-12 my-auto">
			...
			<div className="col-span-4 md:col-span-8 lg:col-span-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 mt-[64px]">
