...
const Preloader = () => {
	...
	return (
		<div
			ref={container}
			className="preloader fixed inset-0 z-50 bg-(--dark) flex flex-col items-center justify-center h-screen w-screen overflow-hidden"
		>
			<p className="absolute top-10 text-white">Desarrollador Web</p>
			<div className="master_proloader"></div>
			<div ref={counterRef} className="counter-preloader text-[2.5rem] text-(--white)">
				00%
			</div>
		</div>
	);
